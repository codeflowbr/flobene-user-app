...
import 'senha_saque_model.dart';
export 'senha_saque_model.dart';

class SenhaSaqueWidget extends StatefulWidget {
  const SenhaSaqueWidget({
    super.key,
    required this.json,
    required this.valor,
  });
  ...
  @override
  State<SenhaSaqueWidget> createState() => _SenhaSaqueWidgetState();
}

class _SenhaSaqueWidgetState extends State<SenhaSaqueWidget>
    with TickerProviderStateMixin {
  late SenhaSaqueModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SenhaSaqueModel());
