...
import 'cadastro_lojista_model.dart';
export 'cadastro_lojista_model.dart';

class CadastroLojistaWidget extends StatefulWidget {
  const CadastroLojistaWidget({super.key});

  @override
  State<CadastroLojistaWidget> createState() => _CadastroLojistaWidgetState();
}

class _CadastroLojistaWidgetState extends State<CadastroLojistaWidget> {
  late CadastroLojistaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroLojistaModel());

    _model.cnpjTextController ??= TextEditingController();
    _model.cnpjFocusNode ??= FocusNode();
    _model.cnpjFocusNode!.addListener(() => setState(() {}));
    _model.razaoSocialTextController ??= TextEditingController();
    _model.razaoSocialFocusNode ??= FocusNode();
    _model.razaoSocialFocusNode!.addListener(() => setState(() {}));
    _model.nomeFantasiaTextController ??= TextEditingController();
    _model.nomeFantasiaFocusNode ??= FocusNode();
    _model.nomeFantasiaFocusNode!.addListener(() => setState(() {}));
    _model.telefoneTextController ??= TextEditingController();
    _model.telefoneFocusNode ??= FocusNode();
    _model.telefoneFocusNode!.addListener(() => setState(() {}));
    _model.cepTextController ??= TextEditingController();
    _model.cepFocusNode ??= FocusNode();
    _model.cepFocusNode!.addListener(() => setState(() {}));
    _model.numeroCasaTextController ??= TextEditingController();
    _model.numeroCasaFocusNode ??= FocusNode();
    _model.numeroCasaFocusNode!.addListener(() => setState(() {}));
    _model.estadoTextController ??= TextEditingController();
    _model.estadoFocusNode ??= FocusNode();
    _model.estadoFocusNode!.addListener(() => setState(() {}));
    _model.cidadeTextController ??= TextEditingController();
    _model.cidadeFocusNode ??= FocusNode();
    _model.cidadeFocusNode!.addListener(() => setState(() {}));
    _model.bairroTextController ??= TextEditingController();
    _model.bairroFocusNode ??= FocusNode();
    _model.bairroFocusNode!.addListener(() => setState(() {}));
    _model.ruaTextController ??= TextEditingController();
    _model.ruaFocusNode ??= FocusNode();
    _model.ruaFocusNode!.addListener(() => setState(() {}));
    _model.complementoTextController ??= TextEditingController();
    _model.complementoFocusNode ??= FocusNode();
    _model.complementoFocusNode!.addListener(() => setState(() {}));
    _model.nomeDonoTextController ??= TextEditingController();
    _model.nomeDonoFocusNode ??= FocusNode();
    _model.nomeDonoFocusNode!.addListener(() => setState(() {}));
    _model.emailDonoTextController ??= TextEditingController();
    _model.emailDonoFocusNode ??= FocusNode();
    _model.emailDonoFocusNode!.addListener(() => setState(() {}));
    _model.telefoneDonoTextController ??= TextEditingController();
    _model.telefoneDonoFocusNode ??= FocusNode();
    _model.telefoneDonoFocusNode!.addListener(() => setState(() {}));
    _model.cpfDonoTextController ??= TextEditingController();
    _model.cpfDonoFocusNode ??= FocusNode();
    _model.cpfDonoFocusNode!.addListener(() => setState(() {}));
    _model.dataNascimentoTextController ??= TextEditingController();
    _model.dataNascimentoFocusNode ??= FocusNode();
    _model.dataNascimentoFocusNode!.addListener(() => setState(() {}));
    _model.logiTextController1 ??= TextEditingController();
    _model.logiFocusNode1 ??= FocusNode();
    _model.logiFocusNode1!.addListener(() => setState(() {}));
    _model.logiTextController2 ??= TextEditingController();
    _model.logiFocusNode2 ??= FocusNode();
    _model.logiFocusNode2!.addListener(() => setState(() {}));
    _model.pixTextController ??= TextEditingController();
    _model.pixFocusNode ??= FocusNode();
    _model.pixFocusNode!.addListener(() => setState(() {}));
  }
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    controller:
                                        _model.nomeFantasiaTextController,
                                    focusNode: _model.nomeFantasiaFocusNode,
                                    autofocus: true,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                                    ...
                                    cursorColor:
                                        FlutterFlowTheme.of(context).primary,
                                    validator: _model
                                        .nomeFantasiaTextControllerValidator
                                        .asValidator(context),
                                  ),
                                  TextFormField(
                                  ...
                                  TextFormField(
                                    controller: _model.numeroCasaTextController,
                                    focusNode: _model.numeroCasaFocusNode,
                                    autofocus: true,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                                    ...
                                    cursorColor:
                                        FlutterFlowTheme.of(context).primary,
                                    validator: _model
                                        .numeroCasaTextControllerValidator
                                        .asValidator(context),
                                  ),
                                  TextFormField(
                                  ...
                                  TextFormField(
                                    controller: _model.nomeDonoTextController,
                                    focusNode: _model.nomeDonoFocusNode,
                                    autofocus: true,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                                    ...
                                    cursorColor:
                                        FlutterFlowTheme.of(context).primary,
                                    validator: _model
                                        .nomeDonoTextControllerValidator
                                        .asValidator(context),
                                  ),
                                  TextFormField(
                                    controller: _model.emailDonoTextController,
                                    focusNode: _model.emailDonoFocusNode,
                                    autofocus: true,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                                    ...
                                    cursorColor:
                                        FlutterFlowTheme.of(context).primary,
                                    validator: _model
                                        .emailDonoTextControllerValidator
                                        .asValidator(context),
                                  ),
                                  TextFormField(
                                    controller:
                                        _model.telefoneDonoTextController,
                                    focusNode: _model.telefoneDonoFocusNode,
                                    autofocus: true,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                                    ...
                                    cursorColor:
                                        FlutterFlowTheme.of(context).primary,
                                    validator: _model
                                        .telefoneDonoTextControllerValidator
                                        .asValidator(context),
                                    inputFormatters: [_model.telefoneDonoMask],
                                  ),
                                  TextFormField(
                                    controller: _model.cpfDonoTextController,
                                    focusNode: _model.cpfDonoFocusNode,
                                    autofocus: true,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                                    ...
                                    cursorColor:
                                        FlutterFlowTheme.of(context).primary,
                                    validator: _model
                                        .cpfDonoTextControllerValidator
                                        .asValidator(context),
                                    inputFormatters: [_model.cpfDonoMask],
                                  ),
                                  Row(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                                  ...
                                  TextFormField(
                                    controller: _model.logiTextController1,
                                    focusNode: _model.logiFocusNode1,
                                    autofocus: true,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                                  ...
                                  TextFormField(
                                    ...
                                    cursorColor:
                                        FlutterFlowTheme.of(context).primary,
                                    validator: _model.pixTextControllerValidator
                                        .asValidator(context),
                                  ),
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                  ...
                                  PinCodeTextField(
                                    ...
                                    controller: _model.senhaTransacao,
                                    onChanged: (_) {},
                                    autovalidateMode: AutovalidateMode.disabled,
